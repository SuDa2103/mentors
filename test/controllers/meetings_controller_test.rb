...
class MeetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meeting" do
    assert_difference('Meeting.count') do
      post meetings_url, params: { meeting: { mentor_id: @meeting.mentor_id, user_id: @meeting.user_id } }
    end
  ...
  test "should update meeting" do
    patch meeting_url(@meeting), params: { meeting: { mentor_id: @meeting.mentor_id, user_id: @meeting.user_id } }
